  ...
  async function fetching() {
    try {
      const response = await fetch(
        "https://mmvnpcrggdthdsckmmpv.supabase.co/rest/v1/project",
        {
          headers: {
            apikey:
              "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1tdm5wY3JnZ2R0aGRzY2ttbXB2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODIyNDM4MTgsImV4cCI6MTk5NzgxOTgxOH0.ZpTCKVBeQhYw8l6izzV5U-91mubrPYtLCMVCUyHkkDY",
            Authorization:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1tdm5wY3JnZ2R0aGRzY2ttbXB2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODIyNDM4MTgsImV4cCI6MTk5NzgxOTgxOH0.ZpTCKVBeQhYw8l6izzV5U-91mubrPYtLCMVCUyHkkDY",
          },
        }
      );
